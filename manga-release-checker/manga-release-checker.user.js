...
(function() {
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(response) {
            ...
            var readingList = [
				cleanText('Yaoguai Mingdan'), cleanText('Household Affairs'), cleanText('Sweet Guy'), cleanText('Golden Kamui'), cleanText('Gosu'),
				cleanText('Aka Akatoretachi no Monogatari'), cleanText('Yahari Ore no Seishun Rabukome wa Machigatte Iru. - Mougenroku'),
				cleanText('Youkai Shoujo - Monsuga'), cleanText('Tamen de Gushi'), cleanText('Ane Log'), cleanText('Rainbow'), cleanText('Inu Yashiki'),
				cleanText('Fushi no Ryouken'), cleanText('My Wives'), cleanText('Okitenemuru'), cleanText('Mujang'), cleanText('Hentai Ouji to Warawanai Neko'),
				cleanText('Platina End'), cleanText('Denkigai no Honya-san'), cleanText('Kangoku Gakuen'), cleanText('Shen Yin Wang Zuo'), cleanText('Suicide Island')
			],
