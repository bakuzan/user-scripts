...
var voiceActors = xpath("//td[@valign='top'][@style='padding-left: 5px;']/table[@width='100%'][@cellspacing='0'][@cellpadding='0'][@border='0'][descendant::div[@style='margin-top: 2px;']/small[not(contains(., 'Japanese'))]]");
function showJap() {
