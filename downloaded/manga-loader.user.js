...
// @match *://www.mangainn.me/manga/chapter/*
...
var implementations = [{
  ...
  match: "^https?://view\\.thespectrum\\.net/series/[^\\.]+\\.html\\?ch=[^&]+&page=[0-9]+",
  img: '#mainimage',
  next: '#mainimage',
  numpages: '.selectpage',
  curpage: '.selectpage',
  ...
  img: function(ctx) {
    ...
    imgs.some(function(img) {
      if(img.src.indexOf('http://2.bp.blogspot') > -1) {
        found = img.src;
        return true;
      }
    });
  ...
  name: 'mangainn',
  match: "^https?://www.mangainn.me/manga/chapter/.+",
  img: '#imgPage',
  next: function() {
